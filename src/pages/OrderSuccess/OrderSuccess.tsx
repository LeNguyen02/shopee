      ...
      <div className='bg-neutral-100 py-16'>
        <div className='container'>
          <div className='text-center'>
            <h1 className='text-4xl font-bold text-gray-800 mb-4'>Không tìm thấy thông tin đơn hàng</h1>
            <Button
      ...
      <div className='container max-w-4xl'>
        <div className='bg-white rounded-lg shadow p-8'>
          ...
          <div className='text-center mb-8'>
            ...
            <h1 className='text-4xl font-bold text-green-600 mb-2'>Đặt hàng thành công!</h1>
            <p className='text-lg text-gray-600'>Cảm ơn bạn đã mua sắm tại Shopee</p>
          </div>
          ...
          <div className='bg-gray-50 rounded-lg p-6 mb-8'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
              <div>
                <h3 className='text-lg font-medium text-gray-700 mb-2'>Mã đơn hàng</h3>
                <p className='text-xl font-semibold text-orange'>{order.id}</p>
              </div>
              <div>
                <h3 className='text-lg font-medium text-gray-700 mb-2'>Ngày đặt hàng</h3>
                <p className='text-lg'>{new Date(order.created_at).toLocaleDateString('vi-VN')}</p>
              </div>
              <div>
                <h3 className='text-lg font-medium text-gray-700 mb-2'>Phương thức thanh toán</h3>
                <p className='text-lg capitalize'>
                  {order.payment_method === 'cod' ? 'Thanh toán khi nhận hàng (COD)' : 'Thanh toán bằng thẻ (Stripe)'}
                </p>
              </div>
              <div>
                <h3 className='text-lg font-medium text-gray-700 mb-2'>Trạng thái thanh toán</h3>
          ...
          {/* Delivery Address */}
          <div className='bg-gray-50 rounded-lg p-6 mb-8'>
            <h2 className='text-2xl font-semibold mb-4'>Địa chỉ giao hàng</h2>
          ...
          {/* Order Items */}
          <div className='mb-8'>
            <h2 className='text-2xl font-semibold mb-4'>Sản phẩm đã đặt</h2>
          ...
          {order.message && (
            <div className='bg-gray-50 rounded-lg p-6 mb-8'>
              <h2 className='text-2xl font-semibold mb-4'>Ghi chú đơn hàng</h2>
