      ...
      <div className='container'>
        {cartItems.length > 0 ? (
          ...
          <div className='text-center'>
            ...
            <div className='mt-5 text-2xl font-bold text-gray-400 mb-5'>{t('cart.your_cart_is_empty')}</div>
